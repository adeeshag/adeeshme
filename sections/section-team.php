            ...
            echo '<div class="mt-team-description">';
                ...
                if ( $pixova_lite_team_member_1_fburl ) {
                    echo '<div class="mt-team-member-icon">';
                        echo '<a rel="nofollow" href="' . esc_url( $pixova_lite_team_member_1_fburl ). '"><i class="fa  fa-linkedin-square"></i></a>';
                    echo '</div><!--/.mt-team-member-icon-->';
                }

                if ( $pixova_lite_team_member_1_dribbble_url ) {
                    echo '<div class="mt-team-member-icon">';
                        echo '<a rel="nofollow" href="' . esc_url( $pixova_lite_team_member_1_dribbble_url ). '"><i class="fa fa-twitter"></i></a>';
                    echo '</div><!--/.mt-team-member-icon-->';
                }
