...
// Section #5 Chart
$pixova_lite_section_5_chart_heading = get_theme_mod('pixova_lite_about_section_chart_5_heading', __('Graphic Identity', 'pixova-lite') );
$pixova_lite_section_5_chart_percentage = get_theme_mod('pixova_lite_about_section_chart_5_percentage', '70');
$pixova_lite_section_5_chart_bar_color = get_theme_mod('pixova_lite_about_section_chart_5_bar_color', '#2cc36b');
$pixova_lite_section_5_chart_track_color = get_theme_mod('pixova_lite_about_section_chart_5_track_color', '#EEEEEE');

// Section #6 Chart
$pixova_lite_section_6_chart_heading = get_theme_mod('pixova_lite_about_section_chart_6_heading', __('Graphic Identity', 'pixova-lite') );
$pixova_lite_section_6_chart_percentage = get_theme_mod('pixova_lite_about_section_chart_6_percentage', '70');
$pixova_lite_section_6_chart_bar_color = get_theme_mod('pixova_lite_about_section_chart_6_bar_color', '#2cc36b');
$pixova_lite_section_6_chart_track_color = get_theme_mod('pixova_lite_about_section_chart_6_track_color', '#EEEEEE');

// Section #7 Chart
$pixova_lite_section_7_chart_heading = get_theme_mod('pixova_lite_about_section_chart_7_heading', __('Graphic Identity', 'pixova-lite') );
$pixova_lite_section_7_chart_percentage = get_theme_mod('pixova_lite_about_section_chart_7_percentage', '70');
$pixova_lite_section_7_chart_bar_color = get_theme_mod('pixova_lite_about_section_chart_7_bar_color', '#2cc36b');
$pixova_lite_section_7_chart_track_color = get_theme_mod('pixova_lite_about_section_chart_7_track_color', '#EEEEEE');

// Section #8 Chart
$pixova_lite_section_8_chart_heading = get_theme_mod('pixova_lite_about_section_chart_8_heading', __('Graphic Identity', 'pixova-lite') );
$pixova_lite_section_8_chart_percentage = get_theme_mod('pixova_lite_about_section_chart_8_percentage', '70');
$pixova_lite_section_8_chart_bar_color = get_theme_mod('pixova_lite_about_section_chart_8_bar_color', '#2cc36b');
$pixova_lite_section_8_chart_track_color = get_theme_mod('pixova_lite_about_section_chart_8_track_color', '#EEEEEE');
...
if( isset( $pixova_lite_section_5_chart_percentage ) && is_numeric( $pixova_lite_section_5_chart_percentage) ) {
	$pixova_lite_no_of_charts++;
}

if( isset( $pixova_lite_section_6_chart_percentage ) && is_numeric( $pixova_lite_section_6_chart_percentage) ) {
	$pixova_lite_no_of_charts++;
}

if( isset( $pixova_lite_section_7_chart_percentage ) && is_numeric( $pixova_lite_section_7_chart_percentage) ) {
	$pixova_lite_no_of_charts++;
}

if( isset( $pixova_lite_section_8_chart_percentage ) && is_numeric( $pixova_lite_section_8_chart_percentage) ) {
	$pixova_lite_no_of_charts++;
}
...
} else if($pixova_lite_no_of_charts == 5){
    $pixova_lite_cols = 'col-xs-12';
	$pixova_lite_chart_size = 'col-md-3 col-sm-6 col-xs-12';
} else if($pixova_lite_no_of_charts == 6){
    $pixova_lite_cols = 'col-xs-12';
	$pixova_lite_chart_size = 'col-md-3 col-sm-6 col-xs-12';
} else if($pixova_lite_no_of_charts == 7){
    $pixova_lite_cols = 'col-xs-12';
	$pixova_lite_chart_size = 'col-md-3 col-sm-6 col-xs-12';
} else if($pixova_lite_no_of_charts == 8){
    $pixova_lite_cols = 'col-xs-12';
	$pixova_lite_chart_size = 'col-md-3 col-sm-6 col-xs-12';
}
...
echo '<div class="pixova_lite_pie_chart_wrapper '.$pixova_lite_cols.'">';
		...
		if(isset($pixova_lite_section_5_chart_percentage) && is_numeric( $pixova_lite_section_5_chart_percentage) ) {
			echo '<div class="pixova_lite_chart_5 '.$pixova_lite_chart_size.'">';
				echo '<div class="mt-chart" data-trackColor="'.esc_html( $pixova_lite_section_5_chart_track_color ).'" data-barColor="'.esc_html( $pixova_lite_section_5_chart_bar_color ).'" data-lineWidth="10" data-percent="'.esc_html( $pixova_lite_section_5_chart_percentage ).'">';
					echo'<div class="mt-pie-chart-custom-text">';
						echo esc_html( $pixova_lite_section_5_chart_percentage ).'%';
	    			echo'</div><!--/.mt-pie-chart-custom-text-->';
	        	echo '</div><!--/.mt-chart-->';
	        	if( isset( $pixova_lite_section_5_chart_heading ) ) {
		        	echo '<h4 class="mt-heading mt-heading-single-line text-center">';
		        		echo esc_html( $pixova_lite_section_5_chart_heading );
		        	echo '</h4><!--/.mt-heading-->';
	        	}
	        echo '</div><!--/.col-md-->';
        }
		if(isset($pixova_lite_section_6_chart_percentage) && is_numeric( $pixova_lite_section_6_chart_percentage) ) {
			echo '<div class="pixova_lite_chart_4 '.$pixova_lite_chart_size.'">';
				echo '<div class="mt-chart" data-trackColor="'.esc_html( $pixova_lite_section_6_chart_track_color ).'" data-barColor="'.esc_html( $pixova_lite_section_6_chart_bar_color ).'" data-lineWidth="10" data-percent="'.esc_html( $pixova_lite_section_6_chart_percentage ).'">';
					echo'<div class="mt-pie-chart-custom-text">';
						echo esc_html( $pixova_lite_section_6_chart_percentage ).'%';
	    			echo'</div><!--/.mt-pie-chart-custom-text-->';
	        	echo '</div><!--/.mt-chart-->';
	        	if( isset( $pixova_lite_section_6_chart_heading ) ) {
		        	echo '<h4 class="mt-heading mt-heading-single-line text-center">';
		        		echo esc_html( $pixova_lite_section_6_chart_heading );
		        	echo '</h4><!--/.mt-heading-->';
	        	}
	        echo '</div><!--/.col-md-->';
        }
		if(isset($pixova_lite_section_7_chart_percentage) && is_numeric( $pixova_lite_section_7_chart_percentage) ) {
			echo '<div class="pixova_lite_chart_4 '.$pixova_lite_chart_size.'">';
				echo '<div class="mt-chart" data-trackColor="'.esc_html( $pixova_lite_section_7_chart_track_color ).'" data-barColor="'.esc_html( $pixova_lite_section_7_chart_bar_color ).'" data-lineWidth="10" data-percent="'.esc_html( $pixova_lite_section_7_chart_percentage ).'">';
					echo'<div class="mt-pie-chart-custom-text">';
						echo esc_html( $pixova_lite_section_7_chart_percentage ).'%';
	    			echo'</div><!--/.mt-pie-chart-custom-text-->';
	        	echo '</div><!--/.mt-chart-->';
	        	if( isset( $pixova_lite_section_7_chart_heading ) ) {
		        	echo '<h4 class="mt-heading mt-heading-single-line text-center">';
		        		echo esc_html( $pixova_lite_section_7_chart_heading );
		        	echo '</h4><!--/.mt-heading-->';
	        	}
	        echo '</div><!--/.col-md-->';
        }
		if(isset($pixova_lite_section_8_chart_percentage) && is_numeric( $pixova_lite_section_8_chart_percentage) ) {
			echo '<div class="pixova_lite_chart_4 '.$pixova_lite_chart_size.'">';
				echo '<div class="mt-chart" data-trackColor="'.esc_html( $pixova_lite_section_8_chart_track_color ).'" data-barColor="'.esc_html( $pixova_lite_section_8_chart_bar_color ).'" data-lineWidth="10" data-percent="'.esc_html( $pixova_lite_section_8_chart_percentage ).'">';
					echo'<div class="mt-pie-chart-custom-text">';
						echo esc_html( $pixova_lite_section_8_chart_percentage ).'%';
	    			echo'</div><!--/.mt-pie-chart-custom-text-->';
	        	echo '</div><!--/.mt-chart-->';
	        	if( isset( $pixova_lite_section_8_chart_heading ) ) {
		        	echo '<h4 class="mt-heading mt-heading-single-line text-center">';
		        		echo esc_html( $pixova_lite_section_8_chart_heading );
		        	echo '</h4><!--/.mt-heading-->';
	        	}
	        echo '</div><!--/.col-md-->';
        }
