                        ...
                        echo '<div class="col-md-12">';
                            ...
                            echo '<div id="intro-services-wrap">';
                                ...
                                echo '<!-- /intro service -->';
                                    ...
                                    echo '<div class="intro-services col-md-4 col-sm-4 col-xs-4">';
                                    echo '<span style="color: '.pixova_lite_hex2rgba('#FFFFFF').'" class="fa fa-laptop"></span>';
                                ...
                                echo '<div class="intro-services col-md-4 col-sm-4 col-xs-4">';
                                    echo '<span style="color: '.pixova_lite_hex2rgba('#FFFFFF').'" class="fa fa-wrench"></span>';
